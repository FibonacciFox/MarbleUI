...
class UIDisplay
{
    ...
    /**
     * Returns the default display. One is created (making the thread that invokes this method its user-interface
     * thread) if it did not already exist.
     *
     * @return UIDisplay
     */
     ...
     * is potentially more work to do, or false if the caller can sleep until another event is placed on the event
     * queue.
     *
     * @return bool
     */
